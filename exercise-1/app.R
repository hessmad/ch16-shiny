...
ui <- fluidPage(
  ...
  p("This is my first Shiny project and I am so", strong("excited"),
  ...
  p("Sliders are really", em("cool"),
    ". We can use them to make our data interactive."),
  
  # A slider with an appropriate label, min of 10, max of 100, value of 50  
  sliderInput("My first slider", "My first slider", min = 10, max = 100, value = 50))
